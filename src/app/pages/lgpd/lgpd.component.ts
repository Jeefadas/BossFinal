...
@Component({
  ...
  <section class="section"><div class="container legal">
    <article class="card"><span>01</span><div><h2>Quais dados são utilizados?</h2><p>Nome, e-mail, cidade, tipo de conta e, para advogados, informações profissionais como OAB, áreas de atuação, qualificações e contato. Quando o usuário utiliza recursos da plataforma, também podem existir mensagens, favoritos e dados de solicitações de atendimento.</p></div></article>
    <article class="card"><span>02</span><div><h2>Por que esses dados são utilizados?</h2><p>Para permitir cadastro, login, personalização dos perfis, busca de profissionais, conversas entre cliente e advogado, notificações, favoritos e gerenciamento de solicitações de atendimento.</p></div></article>
